      ...
      <div className="max-w-2xl mx-auto">
        <Card className="border-primary">
          <CardHeader>
            ...
            <CardDescription>
              This page demonstrates the Vercel feature flags implementation.
              Only users with an active Plus plan subscription can access this
              page. The feature flag checks your subscription status in
              real-time.
            </CardDescription>
          </CardHeader>
        </Card>
